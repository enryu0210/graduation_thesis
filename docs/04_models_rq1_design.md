...
| 5 | 제안 CNN — gray(1ch) | 48×48 이미지 | 0.9707 | 0.9714 | 0.9609 | 0.9914 | 0.0281 | 0.0200 | 92,466 |
| **6** | **제안 CNN — RGB rb/cc/bd** | **48×48×3 이미지** | **0.9832** | **0.9836** | **0.9775** | **0.9963** | **0.0131** | 0.0212 | 81,964 |
...
- **RGB 강화는 제안 CNN을 크게 끌어올렸다**: gray 대비 MCC 0.9609→0.9775(**+1.66pp**),
...
| 3 | 제안 CNN rgb rb/cc/le | 0.9762 ± 0.0025 | 0.0148 ± 0.0029 |
| 4 | 제안 CNN rgb rb/cc/bd | 0.9761 ± 0.0051 | 0.0163 ± 0.0053 |
| 5 | 제안 CNN rgb rb/ss/le | 0.9723 ± 0.0062 | 0.0185 ± 0.0050 |
| 6 | 제안 CNN rgb rb/bp/le | 0.9718 ± 0.0034 | 0.0167 ± 0.0025 |
| 7 | TF-IDF + LogReg | 0.9686 ± 0.0011 | 0.0290 ± 0.0011 |
| 8 | 제안 CNN gray | 0.9493 ± 0.0109 | 0.0310 ± 0.0055 |

(BiLSTM 은 계산 비용 대비 정보량이 낮아 제외 — 단일 split 에서 char-CNN 에 뒤졌고,
"제안 CNN vs 텍스트 베이스라인 최강자" 비교는 char-CNN 으로 충분히 판정된다.)

### 통계적으로 확정된 것 / 확정 안 된 것

**① 확정 — 제안 CNN 은 텍스트 베이스라인에 유의하게 열세다.**
char-CNN 은 제안 CNN 의 **모든 RGB 조합보다 유의 우세**(adj p = 0.0010 ~ 0.0247),
...
정확도 경쟁에서는 졌다(①). 남는 것은 **처리량**이다 — 제안 CNN RGB 81,964 samples/s 대
...
- [x] 통계 검증: 5-fold CV + paired t-test(설계 6.1) — **완료(5.1절)**. 제안 CNN 의 텍스트
